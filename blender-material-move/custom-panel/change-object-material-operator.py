...
class ChangeMaterialColor(bpy.types.Operator):
    ...
    bl_idname = "material.change_object_material"    # Unique identifier for buttons and menu items to reference.
    bl_label = "Change material of an object"         # Display name in the interface.
    bl_options = {'REGISTER', 'UNDO'}  # Enable undo for the operator.
    
    def partially_clean(self):
...
#        print(material)
#        objectMaterialList = bpy.context.object.data.materials
##        print(objectMaterialList)
#        if not name in objectMaterialList:
#            objectMaterialList.append(material)
#        mIndex=0
#        for m in objectMaterialList:
#            if m == material:
#                break
#            mIndex += 1
        
#        print("mIndex = ", mIndex)
#        mIndex = objectMaterialList.index(material)
#        bpy.context.active_object.active_material_index = mIndex
